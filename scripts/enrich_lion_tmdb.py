import json, ssl, time, urllib.request, os, shutil, re, sys

API_KEY = '5d71ba15ace52c171577c1fa5df4c573'
INPUT   = 'data/lion-metadata-82.json'
OUTPUT  = 'data/lion_metadata.js'
SRC_DIR = 'posters_local/GoldenLion'
DST_DIR = 'posters_local/GoldenLion-TMDB'
GAP     = 0.3
MAX_RETRY = 3
...
# 写 JS
js = 'const GOLDEN_LION_DATA = ' + json.dumps(items, ensure_ascii=False, indent=2) + ';\n'
